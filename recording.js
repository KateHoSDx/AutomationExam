"use strict";
await page.goto("https://signon-acc1.globepayroll.net/auth/realms/globalsolutions-reference/protocol/openid-connect/auth?client_id=GPFRONT&redirect_uri=https%3A%2F%2Fglobalsolutions-reference.gpi-test.globepayroll.net%2Fui%2F%23%2Fdashboard&state=d3d4ea1b-d7e9-46c0-aed2-101cf0538af4&response_mode=fragment&response_type=code&scope=openid&nonce=b9f1f132-328b-462c-95d3-6bfd4d8c5bcb");
...
await page
    .getByText("Sign in to your account Username or email Password Forgot Password? Sign In Or")
    .click();
